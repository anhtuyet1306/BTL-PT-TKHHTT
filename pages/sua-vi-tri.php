...
$pageTitle = 'Sửa vị trí tuyển dụng';
...
try {
    ...
    die('Lỗi lấy dữ liệu vị trí tuyển dụng.');
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            $errors[] = 'Không thể cập nhật vị trí tuyển dụng: ' . $e->getMessage();
        }
    }
}
    ...
    <form method="POST">
            ...
            <select name="MaPhongBan" class="select-control" required>
                ...
                <?php foreach ($departments as $department): ?>
                    <option
                        ...
                        <?= ((string)($data['MaPhongBan'] ?? '') === (string)$department['MaPhongBan']) ? 'selected' : '' ?>
                    >
        ...
        <div class="form-group">
            ...
            <input
                ...
                name="TenViTri"
                class="input-control"
                value="<?= htmlspecialchars($data['TenViTri'] ?? '') ?>"
                required
            >
        </div>
        ...
        <div class="form-group">
            ...
            <input
                ...
                class="input-control"
                min="1"
                value="<?= htmlspecialchars($data['SoLuong'] ?? '1') ?>"
                required
            >
        </div>
        ...
        <div class="form-group">
            ...
            <textarea
                ...
                class="input-control"
                rows="4"
            ><?= htmlspecialchars($data['MoTa'] ?? '') ?></textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea
                ...
                class="input-control"
                rows="4"
            ><?= htmlspecialchars($data['YeuCau'] ?? '') ?></textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea
                ...
                class="input-control"
                rows="4"
            ><?= htmlspecialchars($data['QuyenLoi'] ?? '') ?></textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <input
                ...
                name="DiaDiem"
                class="input-control"
                value="<?= htmlspecialchars($data['DiaDiem'] ?? '') ?>"
            >
        </div>
        ...
        <div class="form-group">
            ...
            <select name="HinhThucLamViec" class="select-control">
                ...
                <option
                    ...
                    <?= ($data['HinhThucLamViec'] ?? '') === 'Toàn thời gian' ? 'selected' : '' ?>
                >
                    Toàn thời gian
                </option>
                ...
                <option
                    value="Bán thời gian"
                    <?= ($data['HinhThucLamViec'] ?? '') === 'Bán thời gian' ? 'selected' : '' ?>
                >
                    Bán thời gian
                </option>
                ...
                <option
                    value="Thực tập"
                    <?= ($data['HinhThucLamViec'] ?? '') === 'Thực tập' ? 'selected' : '' ?>
                >
                    Thực tập
                </option>
            </select>
        ...
        <div class="form-group">
            <label>
                <input
                    ...
                    name="ThoaThuanLuong"
                    value="1"
                    <?= !empty($data['ThoaThuanLuong']) ? 'checked' : '' ?>
                >
                Thỏa thuận lương
            </label>
        </div>
        ...
        <div class="form-group">
            ...
            <input
                ...
                min="0"
                step="1000"
                value="<?= htmlspecialchars($data['LuongTu'] ?? '') ?>"
            >
        </div>
        ...
        <div class="form-group">
            ...
            <input
                ...
                min="0"
                step="1000"
                value="<?= htmlspecialchars($data['LuongDen'] ?? '') ?>"
            >
        </div>
        ...
        <div class="form-group">
            ...
            <input
                ...
                value="<?= htmlspecialchars(
                    !empty($data['NgayDang'])
                        ? date('Y-m-d\TH:i', strtotime($data['NgayDang']))
                        : ''
                ) ?>"
                required
            >
        ...
        <div class="form-group">
            ...
            <input
                ...
                value="<?= htmlspecialchars(
                    !empty($data['HanNop'])
                        ? date('Y-m-d', strtotime($data['HanNop']))
                        : ''
                ) ?>"
            >
        </div>
        ...
        <div class="form-group">
            ...
            <select name="TrangThai" class="select-control" required>
                ...
                <option
                    value="Đang tuyển"
                    <?= ($data['TrangThai'] ?? '') === 'Đang tuyển' ? 'selected' : '' ?>
                >
                    Đang tuyển
                </option>
                ...
                <option
                    value="Tạm dừng"
                    <?= ($data['TrangThai'] ?? '') === 'Tạm dừng' ? 'selected' : '' ?>
                >
                    Tạm dừng
                </option>
                ...
                <option
                    value="Đã đóng"
                    <?= ($data['TrangThai'] ?? '') === 'Đã đóng' ? 'selected' : '' ?>
                >
                    Đã đóng
                </option>
            </select>
        ...
        <div class="form-group">
            <label>
                <input
                    ...
                    name="HienThi"
                    value="1"
                    <?= !isset($data['HienThi']) || !empty($data['HienThi']) ? 'checked' : '' ?>
                >
                Hiển thị vị trí
            </label>
        </div>
